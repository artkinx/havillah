...
///
class CustomReactiveTextField<T> extends ReactiveFormField<T, String> {
    ...
    String? staticLabelText,
          ...
          builder: (ReactiveFormFieldState<T, String> field) {
            ...
            return Column(
              ...
              children: [
                if (staticLabelText != null)
                  Container(
                    margin: const EdgeInsets.only(bottom: 8.0),
                    child: Text(staticLabelText.toString()),
                  ),
                FancyPasswordField(
                  validationRules: validationRules,
                  hasShowHidePassword:
                      obscureText ? hasShowHidePassword : false,
                  showPasswordIcon: showPasswordIcon,
                  hidePasswordIcon: hidePasswordIcon,
                  hasStrengthIndicator:
                      obscureText ? hasStrengthIndicator : false,
                  strengthIndicatorBuilder: strengthIndicatorBuilder,
...
class _ReactiveFancyPasswordFieldState<T>
  ...
  void initState() {
    ...
    (widget as CustomReactiveTextField<T>).onControllerInit?.call(_controller);
  }
